...
Software engineer with 4+ years of experience developing scalable, high-performance applications using modern web technologies. Adept at leading cross-functional teams to deliver solutions that exceed expectations on time and within budget. Passionate about leveraging technology to drive meaningful change.
...
| Frameworks             | Languages              | Technology              | Other                    |
| ---------------------- | ---------------------- | ----------------------- | ------------------------ |
| React, Next.js         | TypeScript, JavaScript | AWS, Firebase           | SEO, AEO, Semrush        |
| Node.js, Express.js    | HTML, CSS              | Git, GitHub             | Performance Optimization |
| Redux, Zustand         | PHP                    | Sentry, New Relic       | Stripe, PayPal           |
| WordPress, WooCommerce | SQL, No-SQL, GraphQL   | Machine Learning        | Docker                   |
| Tailwind CSS           | C++,                   | Artificial Intelligence | Figma                    |
| Chakra UI, Bootstrap   | Python                 | Sockets, WebRTC         | Cypress, Jest            |
...
## M.Tech. | [National Institute of Technology, Hamirpur (NITH)](https://nith.ac.in/)
...
## B. Tech. | [National Institute of Technology, Hamirpur (NITH)](https://nith.ac.in/)
...
## [PULSE: Proactive uncovering of latent severe anomalous events in IIoT using LSTM-RF model](https://doi.org/10.1007/s10586-024-04653-7) | Cluster Computing (Springer Nature)

Published in July 2024
Topics: Anomaly Detection, LSTM, Random Forest
